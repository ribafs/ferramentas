...
Acesse https://tinyfilemanager.github.io/docs/pwd.html e gere um hash para sua senha e adicione login e senha no config.php. Idealmente remova os existentes e adicione o seu

$auth_users = array(
    'ribafs' => '$2y$10$/K.hjNr84lLNDt8fTXjoI.DBp6PpeyoJ.mGwrrLuCZfAwfSAGqhOW', //senhaforte
);
